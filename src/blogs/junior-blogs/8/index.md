...
![full print](/static/img/junior/8/full_print.webp)
...
<div class="slideshow">
    ...
    <div class="slideshow-track">
        <img src="/static/img/junior/8/pcb_front.webp" alt="pcb front with 3d models">
        <img src="/static/img/junior/8/pcb_back.webp" alt="pcb back with 3d models">
    </div>
...
<div class="slideshow">
    <button class="slideshow-btn prev" type="button">‹</button>
    <div class="slideshow-track">
        <img src="/static/img/junior/8/knob_front.webp" alt="knob front model">
        <img src="/static/img/junior/8/knob_back.webp" alt="knob back model">
    </div>
    <button class="slideshow-btn next" type="button">›</button>
</div>
...
![case top](/static/img/junior/8/case_top.webp)
...
![full assembly](/static/img/junior/8/full.webp)
