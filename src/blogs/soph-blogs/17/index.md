...
so i asked help from <a href="https://timmy.greenlifestylelabs.com/" target="_blank" rel="noopener noreferrer">tim</a> who suggested that i should loft part of it, then extrude the rest of the sides outwards to get the same size and geometry.

![left_trigger_left](/static/img/soph/17/left_trigger_left.webp)
...
![left_trigger_right](/static/img/soph/17/left_trigger_right.webp)

###### right side of the mouse trigger

in the end, my triggers were almost a one-to-one copy of the <a href="https://www.printables.com/model/979182-lightweight-zeromouse-inspired-logitech-mx-mouse-m" target="_blank" rel="noopener noreferrer"> original.</a>

after fixing the general shape, i had to create the “stand” for the mouse to mount onto the shell. 

![stand](/static/img/soph/17/stand.webp)
...
<div class="navigation">
    ...
    <a href="/blogs/soph-blogs/16/" class="buttons"> last week post →</a>
</div>